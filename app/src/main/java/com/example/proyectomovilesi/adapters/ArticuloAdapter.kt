...
class ArticuloAdapter(private val context: Context, private val articulos: List<Articulo>) :
    ...
    override fun onBindViewHolder(holder: ArticuloViewHolder, position: Int) {
        ...
        holder.articleListName.text = articulo.nombre
        holder.articleListSite.text = "n/a"
        if(sitio != null) holder.articleListSite.text = sitio.nombre
        holder.articleListId.text = articulo.id.toString()
